...
public class UniversityRegistration extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RESULT_LOAD_IMAGE && resultCode == RESULT_OK && null != data) {
            ...
            cursor.close();
            ImageView imageView = (ImageView) findViewById(R.id.register_university_logo);
    ...
    private void setSpinnerUniversityObjects(){
        ...
        Spinner spinner_district = (Spinner) findViewById(R.id.register_university_district);
        ...
        Spinner spinner_country = (Spinner) findViewById(R.id.register_university_country);
        ...
        Spinner spinner_institution = (Spinner) findViewById(R.id.register_university_institution);
        ...
        Spinner spinner_university_level = (Spinner) findViewById(R.id.register_university_level);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration = (Spinner) findViewById(R.id.register_university_duration);
        ...
        spinner_university_duration.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level1 = (Spinner) findViewById(R.id.register_university_level1);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration1 = (Spinner) findViewById(R.id.register_university_duration1);
        ...
        spinner_university_duration1.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level2= (Spinner) findViewById(R.id.register_university_level2);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration2 = (Spinner) findViewById(R.id.register_university_duration2);
        ...
        spinner_university_duration2.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level3 = (Spinner) findViewById(R.id.register_university_level3);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration3 = (Spinner) findViewById(R.id.register_university_duration3);
        ...
        spinner_university_duration3.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level4 = (Spinner) findViewById(R.id.register_university_level4);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration4 = (Spinner) findViewById(R.id.register_university_duration4);
        ...
        spinner_university_duration4.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level5 = (Spinner) findViewById(R.id.register_university_level5);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration5 = (Spinner) findViewById(R.id.register_university_duration5);
        ...
        spinner_university_duration5.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level6= (Spinner) findViewById(R.id.register_university_level6);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration6 = (Spinner) findViewById(R.id.register_university_duration6);
        ...
        spinner_university_duration6.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level7 = (Spinner) findViewById(R.id.register_university_level7);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration7 = (Spinner) findViewById(R.id.register_university_duration7);
        ...
        spinner_university_duration7.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level8 = (Spinner) findViewById(R.id.register_university_level8);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration8= (Spinner) findViewById(R.id.register_university_duration8);
        ...
        spinner_university_duration8.setAdapter(
                new NothingSelectedSpinnerAdapter(
                        ...
                        this));
        // Spinner for college_level selection
        Spinner spinner_university_level9 = (Spinner) findViewById(R.id.register_university_level9);
        ...
        // Spinner for college_level selection
        Spinner spinner_university_duration9 = (Spinner) findViewById(R.id.register_university_duration9);
